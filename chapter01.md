...
<table style="width:100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="padding: 10px; border: 1px solid #aaa; text-align: justify;">
        Participa en la investigación de usuarios, la definición de necesidades y la documentación colaborativa del informe.
      </td>
    </tr>
    <tr>
      <td style="padding: 10px; border: 1px solid #aaa;">
      ...
      <td style="padding: 10px; border: 1px solid #aaa; text-align: justify;">
        Participa en el análisis del problema, la elaboración de artefactos de producto y la documentación colaborativa del informe.
      </td>
    </tr>
    <tr>
      <td style="padding: 10px; border: 1px solid #aaa;">
      ...
      <td style="padding: 10px; border: 1px solid #aaa; text-align: justify;">
        Participa en la investigación, el análisis de requisitos y la elaboración de artefactos del proyecto.
      </td>
    </tr>
  </tbody>
</table>
