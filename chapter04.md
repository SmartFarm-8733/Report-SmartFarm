...
La arquitectura de la solución se representa aplicando el C4 Model, elaborado como Diagram-as-Code en Structurizr DSL. El archivo `workspace-smartfarm-c4.dsl` contiene el modelo completo: cuatro personas, seis sistemas externos, nueve containers, setenta y tres componentes clasificados por capa y catorce vistas.
