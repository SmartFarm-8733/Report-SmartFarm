...
|---|---|---|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Arrieta Quispe, Alison Jimena**<br>AV1: pendiente de redacción por la integrante.<br><br>**Avalos Cordova, Diego Andres**<br>AV1: pendiente de redacción por el integrante.<br><br>**Awad Vargas, Giorgio Marzouk**<br>AV1: pendiente de redacción por el integrante.<br><br>**Contreras Leon, Flor de María**<br>AV1: Condujo las seis entrevistas de needfinding a representantes de los dos segmentos objetivo, tres a ganaderos de Apurímac y Cusco y tres a zootecnistas y médicos veterinarios de Cusco, Puno y Chile, y aplicó el cuestionario estructurado complementario a ambos grupos. Elaboró el registro de las entrevistas y el análisis por segmento, cruzando los resultados porcentuales del cuestionario con los resúmenes cualitativos de cada sesión. Asumió la integración de las ramas de capítulo en la rama de desarrollo aplicando GitFlow, verificando que el aporte de cada integrante se incorporara sin pérdida de contenido. Mantuvo la trazabilidad del avance mediante Conventional Commits y el Registro de Versiones del informe, de modo que cualquier integrante pudiera identificar qué se modificó, cuándo y por quién.<br><br>**Romero Meza, Jhimy Pool**<br>AV1: pendiente de redacción por el integrante.<br><br>**Sanchez Arenas, Manuel Angel**<br>AV1: pendiente de redacción por el integrante. | Pendiente de redacción grupal. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **Arrieta Quispe, Alison Jimena**<br>AV1: pendiente de redacción por la integrante.<br><br>**Avalos Cordova, Diego Andres**<br>AV1: pendiente de redacción por el integrante.<br><br>**Awad Vargas, Giorgio Marzouk**<br>AV1: pendiente de redacción por el integrante.<br><br>**Contreras Leon, Flor de María**<br>AV1: Incorporó las observaciones surgidas de la revisión interna del informe sobre artefactos ya elaborados: depuró el Ubiquitous Language de términos técnicos ajenos al dominio, corrigió las fichas de User Persona y los Empathy Maps en UXPressia, y unificó la nomenclatura de la startup, del producto y del dispositivo en los cuatro capítulos. Estableció metas medibles para el modelo de negocio mediante los Business Goals con criterios SMART del Impact Mapping, y tradujo los hallazgos de la investigación en un Product Backlog priorizado por valor de negocio, con la estimación y el sprint previsto de cada historia. Organizó el trabajo en una rama por capítulo para que cada integrante pudiera avanzar sobre el suyo sin bloquear a los demás, y dejó documentada esa convención en la sección de Project Report Collaboration Insights.<br><br>**Romero Meza, Jhimy Pool**<br>AV1: pendiente de redacción por el integrante.<br><br>**Sanchez Arenas, Manuel Angel**<br>AV1: pendiente de redacción por el integrante. | Pendiente de redacción grupal. |
