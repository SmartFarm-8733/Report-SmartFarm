...
|---|---|---| 
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Arrieta Quispe, Alison Jimena**<br>AV1: pendiente de redacción por la integrante.<br><br>**Avalos Cordova, Diego Andres**<br>AV1: Participó en la coordinación y consolidación de los entregables técnicos de los capítulos III y IV. Organizó y detalló las User Stories, el Impact Mapping y el Product Backlog, relacionando las necesidades de los usuarios con las épicas, historias y metas del producto. Posteriormente desarrolló el diseño estratégico y táctico del dominio, modelando el EventStorming, delimitando los Bounded Contexts, definiendo sus relaciones y documentando las capas de dominio, interfaces, aplicación e infraestructura. También integró ajustes provenientes de otros capítulos mediante el uso de ramas y commits descriptivos, manteniendo la trazabilidad de los cambios. Este trabajo permitió conectar de manera consistente las necesidades del usuario, el backlog y la arquitectura de software.<br><br>**Awad Vargas, Giorgio Marzouk**<br>AV1: pendiente de redacción por el integrante.<br><br>**Contreras Leon, Flor de María**<br>AV1: Condujo las seis entrevistas de needfinding a representantes de los dos segmentos objetivo, tres a ganaderos y tres a zootecnistas y médicos veterinarios, y aplicó el cuestionario estructurado complementario a ambos grupos. Elaboró el registro de las seis entrevistas y el análisis por segmento, cruzando los resultados porcentuales del cuestionario con los resúmenes cualitativos de cada sesión. Integró las cuatro ramas de capítulo en la rama de desarrollo aplicando GitFlow, verificando que el aporte de cada integrante se incorporara sin pérdida de contenido, y sincronizó después las cinco ramas de trabajo para que todas partieran del estado completo del informe. Detectó y corrigió una divergencia en la rama del Capítulo IV que, al integrarse, habría revertido el trabajo acumulado en los capítulos I, II y III. Estableció la convención de una rama por capítulo, la documentó en la sección de Project Report Collaboration Insights, y elaboró el Registro de Versiones y la Tabla de Contenidos del informe.<br><br>**Romero Meza, Jhimy Pool**<br>AV1: Participó en la definición y organización de los elementos estratégicos de la propuesta, desarrollando el Solution Profile, el análisis de competidores y la estrategia del producto. Identificó las principales alternativas existentes en el mercado y comparó sus características con la solución propuesta para establecer oportunidades de diferenciación. También participó en el diseño de las entrevistas de needfinding, estructurando preguntas orientadas a obtener información relevante de los segmentos objetivo y procurando que los resultados fueran útiles para validar el problema y las necesidades identificadas. Elaboró las User Personas a partir de la información recopilada durante la investigación, organizando características, necesidades, objetivos, comportamientos y principales dificultades de los usuarios para que el equipo pudiera utilizarlas como referencia en las decisiones de producto.<br><br>**Sanchez Arenas, Manuel Angel**<br>AV1: pendiente de redacción por el integrante. | El equipo concluye que durante AV1 el liderazgo se ejerció de forma distribuida y no centralizada en una sola persona: cada integrante asumió la responsabilidad de un capítulo y de su rama de trabajo, y las decisiones que afectaban a más de un capítulo, como la nomenclatura de la startup y del producto, la cantidad de segmentos objetivo o el alcance del dispositivo físico, se resolvieron en conjunto antes de aplicarse.<br><br>La capacidad de coordinación con actores externos al equipo quedó evidenciada en las seis entrevistas de needfinding realizadas a ganaderos, zootecnistas y médicos veterinarios de Apurímac, Cusco y Puno, y en el cuestionario estructurado aplicado a ambos segmentos. Esas sesiones exigieron contactar a los participantes, ajustar la guía de entrevista al perfil de cada segmento y devolver los hallazgos al equipo en un formato utilizable, lo que sostuvo la continuidad de la comunicación durante todo el ciclo.<br><br>El uso de GitFlow con una rama por capítulo, Conventional Commits y el Registro de Versiones dio al equipo un mecanismo común para saber en todo momento qué se había modificado, cuándo y por quién, sin necesidad de coordinación verbal permanente.<br><br>Como autocrítica, el equipo reconoce que la distribución de aportes en el repositorio fue desigual durante esta entrega y que la integración de las ramas se concentró al final del ciclo. Para TB1 se acuerda asignar de forma explícita un responsable por artefacto, no solo por capítulo, y realizar integraciones parciales semanales en lugar de una sola al cierre. | 
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **Arrieta Quispe, Alison Jimena**<br>AV1: pendiente de redacción por la integrante.<br><br>**Avalos Cordova, Diego Andres**<br>AV1: Contribuyó a establecer una base colaborativa y planificada para el diseño de SmartFarm. Estructuró la arquitectura utilizando el modelo C4 y descompuso la solución en sistema, contenedores y componentes. También documentó las interfaces de la API, las clases de dominio, los componentes técnicos y el diseño lógico de la base de datos, proporcionando una referencia común para la revisión del equipo. Alineó estos artefactos con los Bounded Contexts, las User Stories y las restricciones de conectividad rural, operación offline, integración IoT y acceso web/móvil. Finalmente, versionó los avances en el repositorio mediante commits organizados, facilitando la integración de aportes y el cumplimiento de los objetivos definidos para AV1.<br><br>**Awad Vargas, Giorgio Marzouk**<br>AV1: pendiente de redacción por el integrante.<br><br>**Contreras Leon, Flor de María**<br>AV1: Incorporó las observaciones de la revisión interna sobre artefactos ya elaborados: depuró el Ubiquitous Language de términos ajenos al dominio, corrigió las fichas de User Persona y los Empathy Maps en UXPressia, unificó la nomenclatura de la startup, del producto y del dispositivo en los cuatro capítulos, y corrigió el código de estudiante de un compañero que estaba duplicado en la carátula. Estableció metas medibles para el modelo de negocio mediante los Business Goals con criterios SMART del Impact Mapping, y tradujo los hallazgos de la investigación en un Product Backlog de 71 historias priorizado por valor de negocio, con estimación y sprint previsto. Completó el Capítulo IV con el diseño estratégico y táctico de los contextos acotados, y elaboró los diagramas C4 en Structurizr junto con los diagramas UML y de base de datos en PlantUML, versionando su código fuente en el repositorio para que cualquier integrante pueda regenerarlos.<br><br>**Romero Meza, Jhimy Pool**<br>AV1: Participó en la planificación de los artefactos relacionados con la investigación y definición del producto, coordinando con el equipo la estructura de las entrevistas de needfinding y los aspectos que debían validarse con los segmentos objetivo. Elaboró y organizó las User Personas para representar de manera clara las características y necesidades de los usuarios identificados, contribuyendo a que el equipo contara con una referencia común para orientar las decisiones de diseño. Desarrolló el Solution Profile, el análisis de competidores y la estrategia de la solución, relacionando las necesidades identificadas durante la investigación con las características y diferenciadores propuestos para el producto. Estos aportes permitieron conectar los resultados del needfinding con la definición de la propuesta de valor y mantener una línea común entre las necesidades de los usuarios, la solución planteada y la estrategia del producto.<br><br>**Sanchez Arenas, Manuel Angel**<br>AV1: pendiente de redacción por el integrante. | El equipo concluye que el entorno colaborativo se materializó en la disposición a revisar y corregir artefactos ya elaborados. Los hallazgos de la revisión interna se incorporaron sin fricción: se depuró el Ubiquitous Language de términos ajenos al dominio, se rehicieron las fichas de User Persona y los Empathy Maps en UXPressia, se unificó la nomenclatura en los cuatro capítulos y se corrigieron datos de la carátula. Ninguna de esas correcciones recayó sobre quien había elaborado el artefacto original, lo que muestra que el equipo trata los entregables como producto común y no como propiedad individual.<br><br>El carácter inclusivo del trabajo también se reflejó en las decisiones de producto. La solución incorpora internacionalización en inglés y español latinoamericano y requisitos de accesibilidad, y el diseño contempla explícitamente la operación sin cobertura celular, que es la condición real de los usuarios en las zonas donde se realizó la investigación.<br><br>Respecto al establecimiento de metas y la planificación, el equipo tradujo la investigación en objetivos medibles mediante los Business Goals con criterios SMART del Impact Mapping, y convirtió esos objetivos en un Product Backlog priorizado por valor de negocio, con estimación en Story Points y asignación de sprint. La distinción entre el alcance comprometido para el ciclo y el roadmap posterior se tomó a partir de la capacidad real del equipo y no de la importancia de cada historia.<br><br>Como autocrítica, el equipo identifica que la planificación se formalizó después de haber avanzado en la elaboración de los capítulos, cuando debió preceder al trabajo. Para TB1 se acuerda partir del Sprint Planning y del Sprint Backlog antes de iniciar la implementación, y validar la velocidad real del equipo al cierre del primer sprint para ajustar el alcance de los siguientes con ese dato y no con la estimación inicial. |
