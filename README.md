...
<table style="width: 100%; border-collapse: collapse;">
  ...
  <tbody>
    <tr>
      <td style="border: 1px solid #888; padding: 8px;">u202312031</td>
      <td style="border: 1px solid #888; padding: 8px;">Alison Jimena Arrieta Quispe</td>
      <td style="border: 1px solid #888; padding: 8px;">Team Leader</td>
    </tr>
    <tr>
      <td style="border: 1px solid #888; padding: 8px;">U202320574</td>
      <td style="border: 1px solid #888; padding: 8px;">Manuel Angel Sanchez Arenas</td>
...
|---|---|---|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Arrieta Quispe, Alison Jimena**<br>AV1: Participó en la definición conjunta de la arquitectura general de la solución, coordinando con los integrantes del equipo los principales sistemas, componentes, responsabilidades y relaciones que debían considerarse antes de elaborar el modelo C4 del proyecto. A partir de estos acuerdos, estructuró los diagramas C4 procurando que representaran las decisiones arquitectónicas consensuadas y mantuvieran correspondencia con el alcance funcional definido para SmartFarm. Asimismo, elaboró y estructuró el Big Picture EventStorming del dominio, organizando los Domain Events, su secuencia temporal, actores, sistemas externos, hotspots, oportunidades, eventos pivote y contextos emergentes, de manera que el equipo pudiera construir una comprensión compartida del negocio antes de avanzar hacia decisiones de diseño más detalladas. También participó en la definición y organización de las Epics del producto y en la elaboración de parte de las User Stories, contribuyendo a mantener la trazabilidad entre las necesidades identificadas durante la investigación, las funcionalidades propuestas y la arquitectura acordada por el equipo.<br><br>**Avalos Cordova, Diego Andres**<br>AV1: Coordinó y consolidó los entregables técnicos de los capítulos III y IV, desarrolló User Stories, Impact Mapping, EventStorming y el diseño de los Bounded Contexts, y mantuvo la trazabilidad de los cambios mediante commits organizados.<br><br>**Awad Vargas, Giorgio Marzouk**<br>AV1: Elaboró las User Stories y Epics que permitieron transformar las necesidades identificadas en funcionalidades organizadas para el producto. Preparó la presentación del proyecto, sintetizando los principales avances y aportes del equipo para comunicarlos de manera clara. Asimismo, realizó el seguimiento del avance del proyecto, verificando el cumplimiento de las actividades, identificando tareas pendientes y comunicando oportunamente su estado al equipo para apoyar la toma conjunta de decisiones. Además, incorporó los As-Is Maps de Cesar Flores y Leonardo Rosales al Capítulo II, aportando una representación visual de las actividades, necesidades y puntos de dolor de ambos segmentos para facilitar su comprensión y comunicación dentro del equipo.<br><br>**Contreras Leon, Flor de María**<br>AV1: Condujo las seis entrevistas de needfinding a representantes de los dos segmentos objetivo, tres a ganaderos y tres a zootecnistas y médicos veterinarios, y aplicó el cuestionario estructurado complementario a ambos grupos. Elaboró el registro de las seis entrevistas y el análisis por segmento, cruzando los resultados porcentuales del cuestionario con los resúmenes cualitativos de cada sesión. Integró las cuatro ramas de capítulo en la rama de desarrollo aplicando GitFlow, verificando que el aporte de cada integrante se incorporara sin pérdida de contenido, y sincronizó después las cinco ramas de trabajo para que todas partieran del estado completo del informe. Detectó y corrigió una divergencia en la rama del Capítulo IV que, al integrarse, habría revertido el trabajo acumulado en los capítulos I, II y III. Estableció la convención de una rama por capítulo, la documentó en la sección de Project Report Collaboration Insights, y elaboró el Registro de Versiones y la Tabla de Contenidos del informe.<br><br>**Romero Meza, Jhimy Pool**<br>AV1: Participó en la definición del Solution Profile, el análisis competitivo, la estrategia del producto, el diseño de entrevistas y la elaboración de User Personas.<br><br>**Sanchez Arenas, Manuel Angel**<br>AV1: Desarrollo del Design-Level EventStomring y Mapa de impacto del producto. Con la exploración de las features identificadas en las User Stories realizadas en grupo se facilitó la entrega de estas herramientas. Por otro lado, requerí de la comunicación con otros miembros para la correcta implementación del Lean UX Canvas. | El equipo concluye que durante AV1 el liderazgo se ejerció de forma distribuida y no centralizada en una sola persona: cada integrante asumió la responsabilidad de un capítulo y de su rama de trabajo, y las decisiones que afectaban a más de un capítulo, como la nomenclatura de la startup y del producto, la cantidad de segmentos objetivo, el alcance del dispositivo físico y la arquitectura general de la solución, se resolvieron en conjunto antes de aplicarse.<br><br>La capacidad de coordinación con actores externos al equipo quedó evidenciada en las seis entrevistas de needfinding realizadas a ganaderos, zootecnistas y médicos veterinarios de Apurímac, Cusco y Puno, y en el cuestionario estructurado aplicado a ambos segmentos. Esas sesiones exigieron contactar a los participantes, ajustar la guía de entrevista al perfil de cada segmento y devolver los hallazgos al equipo en un formato utilizable, lo que sostuvo la continuidad de la comunicación durante todo el ciclo.<br><br>El liderazgo conjunto también se reflejó en la construcción de artefactos que requerían decisiones compartidas. La elaboración del Big Picture EventStorming permitió organizar de forma colaborativa los principales eventos y procesos del dominio, mientras que la definición previa de la arquitectura general permitió desarrollar el modelo C4 sobre decisiones discutidas por el equipo y no sobre criterios individuales. Del mismo modo, la estructuración de Epics y User Stories permitió transformar progresivamente los hallazgos del needfinding en funcionalidades concretas y mantener alineados los capítulos de requisitos y diseño.<br><br>El uso de GitFlow con una rama por capítulo, Conventional Commits y el Registro de Versiones dio al equipo un mecanismo común para saber en todo momento qué se había modificado, cuándo y por quién, sin necesidad de coordinación verbal permanente.<br><br>Como autocrítica, el equipo reconoce que la distribución de aportes en el repositorio fue desigual durante esta entrega y que la integración de las ramas se concentró al final del ciclo. Para TB1 se acuerda asignar de forma explícita un responsable por artefacto, no solo por capítulo, y realizar integraciones parciales semanales en lugar de una sola al cierre. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **Arrieta Quispe, Alison Jimena**<br>AV1: Contribuyó a la organización colaborativa de los artefactos de análisis y diseño mediante la elaboración del Big Picture EventStorming, permitiendo que el equipo visualizara de manera común los principales eventos del dominio, su secuencia temporal, los actores involucrados, los sistemas externos, los puntos de incertidumbre, las oportunidades y los contextos emergentes antes de continuar con el diseño de la solución. Participó también en la estructuración de las Epics y en la elaboración de parte de las User Stories, ayudando a descomponer las necesidades identificadas en funcionalidades comprensibles y trazables para el equipo. Para la construcción del modelo C4, coordinó previamente con los integrantes la definición de la arquitectura general del proyecto, de modo que los diagramas representaran decisiones consensuadas acerca de los sistemas, componentes y relaciones principales de la solución. Posteriormente estructuró el C4 como un artefacto compartido para comunicar la arquitectura acordada, contribuyendo a mantener alineados el análisis del dominio, los requisitos funcionales y el diseño arquitectónico del proyecto.<br><br>**Avalos Cordova, Diego Andres**<br>AV1: Estableció una base colaborativa para el diseño mediante C4, documentación de API, clases y base de datos, alineando los artefactos con los requisitos y versionando los avances con commits organizados.<br><br>**Awad Vargas, Giorgio Marzouk**<br>AV1: Organizó las necesidades del producto mediante la elaboración de User Stories y Epics, facilitando que el equipo compartiera una visión común del alcance y pudiera planificar el trabajo. Estructuró el PPT como un recurso colaborativo para presentar de forma ordenada los resultados alcanzados. Además, monitoreó periódicamente el avance del proyecto, contrastando las tareas realizadas con los objetivos previstos, señalando brechas y promoviendo los ajustes necesarios para mantener la trazabilidad y contribuir al cumplimiento de la entrega. Integró ambos As-Is Maps debajo de los User Journey Maps, organizó los recursos gráficos en la estructura del repositorio y sincronizó el aporte con los cambios concurrentes de la rama mediante GitFlow, preservando el trabajo de otros integrantes y la coherencia del informe.<br><br>**Contreras Leon, Flor de María**<br>AV1: Incorporó las observaciones de la revisión interna sobre artefactos ya elaborados: depuró el Ubiquitous Language de términos ajenos al dominio, corrigió las fichas de User Persona y los Empathy Maps en UXPressia, unificó la nomenclatura de la startup, del producto y del dispositivo en los cuatro capítulos, y corrigió el código de estudiante de un compañero que estaba duplicado en la carátula. Estableció metas medibles para el modelo de negocio mediante los Business Goals con criterios SMART del Impact Mapping, y tradujo los hallazgos de la investigación en un Product Backlog de 71 historias priorizado por valor de negocio, con estimación y sprint previsto. Completó el Capítulo IV con el diseño estratégico y táctico de los contextos acotados, y elaboró los diagramas C4 en Structurizr junto con los diagramas UML y de base de datos en PlantUML, versionando su código fuente en el repositorio para que cualquier integrante pueda regenerarlos.<br><br>**Romero Meza, Jhimy Pool**<br>AV1: Coordinó con el equipo la planificación de las entrevistas, organizó User Personas y relacionó los hallazgos del Needfinding con la propuesta de valor y la estrategia del producto.<br><br>**Sanchez Arenas, Manuel Angel**<br>AV1: En este primer sprint de trabajo, tuve que coordinar con mis compañeros las herramientas con las que ibamos a desarrollar los diversos elementos del informe. Finalmente, optamos por designar un espacio en la nube para almacenar archivos y Whatsapp para la exposición de links públicos hacia los espacios de trabajo respectivos. Esto brindó al equipo un fácil acceso y visibilidad a los recursos del proyecto. | El equipo concluye que el entorno colaborativo se materializó en la disposición a revisar y corregir artefactos ya elaborados. Los hallazgos de la revisión interna se incorporaron sin fricción: se depuró el Ubiquitous Language de términos ajenos al dominio, se rehicieron las fichas de User Persona y los Empathy Maps en UXPressia, se unificó la nomenclatura en los cuatro capítulos y se corrigieron datos de la carátula. Ninguna de esas correcciones recayó exclusivamente sobre quien había elaborado el artefacto original, lo que muestra que el equipo trata los entregables como producto común y no como propiedad individual.<br><br>El carácter inclusivo del trabajo también se reflejó en las decisiones de producto. La solución incorpora internacionalización en inglés y español latinoamericano y requisitos de accesibilidad, y el diseño contempla explícitamente la operación sin cobertura celular, que es la condición real de los usuarios en las zonas donde se realizó la investigación.<br><br>Respecto al establecimiento de metas y la planificación, el equipo tradujo la investigación en objetivos medibles mediante los Business Goals con criterios SMART del Impact Mapping, y convirtió esos objetivos en un Product Backlog priorizado por valor de negocio, con estimación en Story Points y asignación de sprint. La distinción entre el alcance comprometido para el ciclo y el roadmap posterior se tomó a partir de la capacidad real del equipo y no únicamente de la importancia de cada historia.<br><br>La planificación también se apoyó en artefactos compartidos que facilitaron mantener una visión común del proyecto. El Big Picture EventStorming permitió organizar y discutir los eventos principales del dominio; las Epics y User Stories transformaron esas necesidades en funcionalidades planificables; y la definición conjunta de la arquitectura antes de elaborar el modelo C4 permitió que el diseño técnico mantuviera correspondencia con los requisitos y decisiones previamente acordadas. Esta secuencia ayudó a disminuir contradicciones entre capítulos y proporcionó referencias comunes para continuar el trabajo.<br><br>Como autocrítica, el equipo identifica que la planificación se formalizó después de haber avanzado en la elaboración de los capítulos, cuando debió preceder al trabajo. Para TB1 se acuerda partir del Sprint Planning y del Sprint Backlog antes de iniciar la implementación, y validar la velocidad real del equipo al cierre del primer sprint para ajustar el alcance de los siguientes con ese dato y no con la estimación inicial. |

**Nota para el equipo.** Cada integrante redacta sus propias acciones en las dos filas del cuadro, describiendo qué hizo concretamente en relación con el criterio de cada fila. Las celdas de Conclusiones se completan de forma grupal y se van expandiendo en cada entrega. Esta sección sustenta el Student Outcome ante la acreditación, por lo que su contenido debe corresponder a la participación real de cada persona y ser coherente con el Registro de Versiones y con los analíticos de colaboración.
