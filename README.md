...
| 0.11.1 | 2026-09-19 | Avalos Cordova, Diego Andres | Depuración de notas internas y placeholders para dejar únicamente el contenido académico del informe. |
...
| Métrica | Valor |
|---|---|
| Commits de contenido | 69 |
| Merges de integración | 6 |
| Commits totales del historial | 76 |
| Ramas activas | 7 |
...
|---|---|---|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Arrieta Quispe, Alison Jimena:** participó en la investigación de usuarios y en la definición de necesidades. <br><br> **Avalos Cordova, Diego Andres:** coordinó la consolidación de los entregables de los capítulos III y IV, organizó las User Stories, el Impact Mapping y el Product Backlog, y desarrolló el modelado estratégico y táctico del dominio. <br><br> **Awad Vargas, Giorgio Marzouk:** participó en el análisis de requisitos, la documentación de artefactos y la revisión colaborativa del informe. <br><br> **Contreras Leon, Flor de María:** condujo las entrevistas de needfinding, elaboró su análisis, integró las ramas de capítulo y mantuvo el Registro de Versiones. <br><br> **Romero Meza, Jhimy Pool:** desarrolló el Solution Profile, el análisis de competidores, la estrategia de la solución y las User Personas. <br><br> **Sanchez Arenas, Manuel Angel:** participó en la definición de la solución y en la documentación colaborativa del informe. | El liderazgo se distribuyó entre los integrantes mediante responsabilidades por capítulo y decisiones coordinadas sobre el alcance, la nomenclatura, los segmentos objetivo y los artefactos compartidos. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | El equipo estructuró el informe por ramas de capítulo, utilizó GitFlow y Conventional Commits, revisó artefactos de forma cruzada y conectó la investigación con los Business Goals, el Product Backlog, el diseño del dominio y la arquitectura. Los integrantes contribuyeron a la investigación, las User Personas, los mapas de experiencia, el modelado del dominio, los diagramas y la integración documental. | La planificación y la revisión conjunta permitieron mantener una línea común entre las necesidades de los usuarios, la propuesta de valor y el diseño de SmartFarm. La trazabilidad del repositorio y el Registro de Versiones permiten identificar la evolución de los aportes y orientar una distribución más equilibrada en las siguientes entregas. |
